...
export default function Cart() {
  ...
  const { cart, removeFromCart, updateQty, clearCart, total } = useCart(); // ajuste si ton context utilise "total" au lieu de "cartTotal"
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="border-t border-amber-200 pt-4">
                <div className="flex justify-between text-lg font-bold text-slate-800">
                  <span>Total</span>
                  <span className="text-2xl text-amber-600">{total.toLocaleString()} FCFA</span>
                </div>
              </div>
            </div>
